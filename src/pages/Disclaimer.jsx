    ...
    <SafeAreaView className="flex-1 bg-[#F8FAFC] dark:bg-slate-950">
      ...
      <View className="flex-1 px-6 justify-center items-center">
        <View className="bg-white dark:bg-slate-900 rounded-3xl p-8 w-full border border-slate-100/50 dark:border-slate-850/50 shadow-sm items-center">
          {/* Decorative Icon */}
          <View className="w-16 h-16 bg-rose-50 dark:bg-rose-900/30 rounded-2xl items-center justify-center mb-6">
          ...
          <View className="w-full">
            <Text className="text-slate-800 dark:text-slate-100 text-lg text-right leading-7 mb-4">
              اس ایپ کو تیار کرنے کا مقصد مومنین کے لیے تعقیباتِ نماز، سورتیں
              اور دعائیں ایک جگہ فراہم کرنا ہے۔ ہماری پوری کوشش رہی ہے کہ تمام
              متن درست اور املا کی غلطیوں سے پاک ہو۔
            </Text>
            ...
            <Text className="text-slate-800 dark:text-slate-100 text-lg text-right leading-7 mb-6">
              ...
              فروگزاشت کا امکان موجود ہے۔ اگر آپ کو ایپ یا کسی آیت، دعا، یا
              تعقیب کے متن میں کوئی غلطی نظر آئے، تو براہِ کرم نیچے دیے گئے
              طریقوں سے ہم سے رابطہ کریں تاکہ اسے جلد از جلد درست کیا جا سکے۔
            </Text>
          </View>
